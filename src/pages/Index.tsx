...
// import loadMemories from '@/api/loadMemories';

// const app = express();
// const port = 3000; // Adjust your port

// // Serve static files from 'memory-cards'
// app.use('/memory-cards', express.static(path.join(__dirname, 'memory-cards')));

// // Use the loadMemories API route
// app.use('/api', loadMemories);
